...
export default function FHECounterDemo() {
  ...
  const {
    ...
    chainId,
    initialMockChains,
    enabled: chainId === 11155111, // Only for Sepolia
  });
  ...
  //////////////////////////////////////////////////////////////////////////////
  // UI Stuff based on official template
  //////////////////////////////////////////////////////////////////////////////
    ...
    return (
      <div className="mx-auto p-8">
        <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded">
          <h2 className="font-bold">FHECounter Not Deployed</h2>
          <p>The FHECounter contract is not deployed on chain {chainId}.</p>
        </div>
      </div>
    );
  }
    ...
    <div className="grid w-full gap-4">
      <div className="col-span-full mx-20 bg-black text-white">
        <p className="font-semibold text-3xl m-5">
          FHEVM React Template - Sepolia Deployment -{" "}
